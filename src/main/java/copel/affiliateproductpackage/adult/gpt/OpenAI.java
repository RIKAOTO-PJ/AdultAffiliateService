...
public class OpenAI implements Transformer {
     ...
     */
    private static final String EMBEDDING_API_URL = System.getenv("OPEN_AI_EMBEDDING_API_URL");
    /**
     * OpenAIのエンベディング処理を実施するモデル名.
     */
    private static final String EMBEDDING_MODEL = System.getenv("OPEN_AI_EMBEDDING_MODEL");
    /**
     * OpenAIの質問応答APIのエンドポイント.
     */
    private static final String COMPLETION_API_URL = System.getenv("OPEN_AI_COMPLETION_API_URL");
    /**
     ...
     */
    private static final Float COMPLETION_TEMPERATURE = Float.valueOf(System.getenv("OPEN_AI_COMPLETION_TEMPERATURE"));
    /**
     * OpenAIのファイルアップロードAPIのエンドポイント.
     */
    private static final String FILE_UPLOAD_URL = System.getenv("OPEN_AI_FILE_UPLOAD_URL");
    /**
     * OpenAIのファインチューニングAPIのエンドポイント.
     */
    private static final String FINE_TUNE_URL = System.getenv("OPEN_AI_FINE_TUNE_URL");
